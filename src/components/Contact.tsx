  ...
  return (
    <section id="contact" className="py-24 bg-darker relative overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto px-6 relative z-10">
        ...
        >
          <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">Let's Create Something Extraordinary</h2>
          ...
          <div className="bg-slate-800/50 p-10 flex flex-col justify-between">
              ...
              <div className="space-y-8">
                <div className="flex items-start gap-4 text-slate-300">
                  ...
                  <div>
                    ...
                    <a href={`mailto:${HERO_CONTENT.email}`} className="hover:text-white transition-colors">{HERO_CONTENT.email}</a>
                  </div>
                </div>
                <div className="flex items-start gap-4 text-slate-300">
            ...
            <div className="mt-12">
              ...
              <div className="flex gap-4">
                {/* Social icons can go here, utilizing the constants */}
